...
class ViewChangeForWho extends StatelessWidget {
  final Function() onTap;

  final c = Get.put(ControllerChangeForWho());

  ViewChangeForWho({Key? key, required this.onTap}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: Container(
                ...
                child: GetBuilder<ControllerChangeForWho>(
                  init: ControllerChangeForWho(),
                  builder: (ctrl) {
