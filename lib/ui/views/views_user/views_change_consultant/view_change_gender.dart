...
import 'package:terapizone/ui/controllers/controllers_user/controller_change_consultant/controller_change_gender.dart';
...
class ViewChangeGender extends StatelessWidget {
  final c = Get.put(ControllerChangeGender());

  ViewChangeGender({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: Container(
                ...
                child: GetBuilder<ControllerChangeGender>(
                  init: ControllerChangeGender(),
                  builder: (ctrl) {
          ...
          Padding(
            ...
            child: ButtonBasic(
                ...
                onTap: () => Get
                    .back() // if post user First Preferences is successfull then open next view in onTap functon
                ),
          ),
        ],
      ),
