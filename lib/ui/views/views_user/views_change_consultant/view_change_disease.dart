...
import 'package:terapizone/ui/controllers/controllers_user/controller_change_consultant/controller_change_topic.dart';
...
class ViewChangeDisease extends StatelessWidget {
  final c = Get.put(ControllerChangeDisease());

  ViewChangeDisease({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: Container(
                ...
                child: GetBuilder<ControllerChangeDisease>(
                  init: ControllerChangeDisease(),
                  builder: (ctrl) {
